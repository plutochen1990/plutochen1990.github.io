...
\name{Tinghuan}{CHEN}
\address{Rm 905, Ho Sin Hang Engineering Building,
The Chinese University of Hong Kong, 
HKSAR}
\mobile{(+86) 15298378576 (Mainland), (+852) 62292349 (HK)}

\email{thchen@cse.cuhk.edu.hk}
\homepage{https://appsrv.cse.cuhk.edu.hk/\textasciitilde thchen/}
%\github{posquit0}
%\linkedin{posquit0}
%\skype{skypeid}
...
\position{Ph.D Student} % Your expertise/fields
%\quote{``Make the change that you want to see in the world."} % A quote or statement

\makecvfooter{\today}{Tinghuan CHEN~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
